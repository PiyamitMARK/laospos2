...
const products = {
  ...
  pad: [
    ...
    { id: 'pad14', name: 'ເປີດຜັດພິກເກືອ / เปิดผัดพริกเกลือ',       price: 75000, image: IMG(1014) },
    ...
    { id: 'pad18', name: 'ເປັດຍ່າງ (ຈານ) / เปิดย่าง (จาน)',         price: 150000, image: IMG(1018) },
    { id: 'pad19', name: 'ຂາໝູລ້ວນ (ຈານ) / ขาหมูล้วน (จาน)',       price: 150000, image: IMG(1019) },
  ],

  // ====== เมนูข้าว-เจ้า / ເມນູເຂົ້າ-ເຈົ້າ ======
  khao: [
    { id: 'khao1',  name: 'ເຂົ້າລາດໝູ / ข้าวหมูแดง',               price: 50000, image: IMG(1020) },
    ...
    { id: 'khao12', name: 'ເຂົ້າມັນໜ້າເປັດ / ข้าวมันหน้าเปิด',      price: 50000, image: IMG(1031) },
